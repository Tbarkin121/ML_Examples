...
# eval_env = AcrobotEnv()
agent = TDLambda(num_actions, num_obs, batch_size=10, num_env=2, replay_buffer_size = 100, ckpts_num=25, ckpt_dir=ckpt_path, lam=lam)
    ...
    with tqdm.trange(max_episodes) as t:
        with summary_writer.as_default():
            for i in t:
                ...
                agent.memory.update_batch(agent.actor)
